...
/* Dir name is hard Coded */
function getDirNotes() {  
	
    var url = "/SyncNotes/getDirNotes?dir=FBNotes"; 
    var ajax = new AJAXInteraction(url, getDirNotescallback); 
    ajax.doGet(); 
}
...
function getDirNotescallback(responseXML) {
     ...
     for (var iNode = 0; iNode < root.childNodes.length; iNode++) {
         ...
         if ( node.childNodes.length > 0) {
             ...
             // addrow("fileNameTable", arr1);
             // addrow("contentTable", arr2);
...
/* Creates a table for Note content */
...
/* Call getDirNotes function on page load */
...
addEvent(window, 'load', getDirNotes);
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<div id="sidebar1" class="sidebar">
					<ul>
						<li><h2><a href="#">Facebook Notes</a></h2>
							<li><h2><a href="#" onclick="javascript:myNotes()">My Notes</a></h2></li>
							<li><h2><a href="#" onclick="javascript:friendNotes()">Friends Note</a></h2></li>
							<ul>
				...
				<div id="content">
					<div class="post">
						...
						<div class="entry">
							...
							<a> Welcome Please choose from menu on the Left</a>
							</table>
							</p>		
