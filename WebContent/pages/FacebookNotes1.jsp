		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<div id="sidebar1" class="sidebar">
					<ul>
						...
						<%			
									...
									HashMap<Integer, HashMap<String, String>> myNotes 
																= notes.getMyNotes();
						
								 	Iterator iterator = myNotes.keySet().iterator();
									while(iterator. hasNext() ){
										key= (Integer)iterator.next();
										note = myNotes.get(key);%><h3>  
				...
				<div id="content">
									...
									<%  	iterator = myNotes.keySet().iterator();
											while(iterator. hasNext() ){
												key= (Integer)iterator.next();
												note = myNotes.get(key);%>
						<div class="post">
